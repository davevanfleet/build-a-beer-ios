...
class SessionManager {
    ...
    init() {
//        deleteKeychainItem(service: "app.buildabeer.buildabeer", account: "appleIDToken") // If your data is corrupted
    }
    ...
    func saveToKeychain(appleIDCredential: ASAuthorizationAppleIDCredential) {
        do {
            ...
            let keychainQuery: [String: Any] = [
                ...
                kSecAttrService as String: "app.buildabeer.buildabeer",
    ...
    var currentUserID: String {
        if let credential = self.retrieveFromKeychain() {
